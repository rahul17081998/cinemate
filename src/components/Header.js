      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark: border-b-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className={`${hidden ? "hidden": ""} items-center justify-between w-full md:flex md:w-auto md:order-1`} id="navbar-search">
              ...
              <li>
                <NavLink exact to="/" className={activeLink === '/' ? activeClass : inActiveClass} onClick={() => handleLinkClick('/')}>Home</NavLink>
              </li>
              <li>
                <NavLink to="/movie/popular" className={activeLink === '/movie/popular' ? activeClass : inActiveClass} onClick={() => handleLinkClick('/movie/popular')}>Popular</NavLink>
              </li>
              <li>
                <NavLink to="/movie/top" className={activeLink === '/movie/top' ? activeClass : inActiveClass} onClick={() => handleLinkClick('/movie/top')}>Top Rated</NavLink>
              </li>
              <li>
                <NavLink to="/movie/upcoming" className={activeLink === '/movie/upcoming' ? activeClass : inActiveClass} onClick={() => handleLinkClick('/movie/upcoming')}>Upcoming</NavLink>
              </li>
              </ul>
            </div>
        </div>
